...
const CSP_BASE = "default-src 'none'; base-uri 'self'; script-src 'self'; style-src 'self' https:; img-src 'self' data:; font-src 'self' https://fonts.gstatic.com; connect-src 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report;";
